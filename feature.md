...
- Quản lý kỹ năng chuyên môn và cấp độ thành thạo
- Thêm chứng chỉ và giải thưởng đạt được
- Điều chỉnh mức độ hiển thị profile cho nhà tuyển dụng
...
- Xem chi tiết thông tin tuyển dụng công khai
- Theo dõi lượt xem và lịch sử xem việc làm
- Nhận đề xuất việc làm cá nhân hóa
...
- Chỉnh sửa và cập nhật nội dung CV
- Xuất CV sang định dạng PDF với template chuyên nghiệp
- Preview CV trước khi sử dụng
...
- Upload tài liệu bổ sung cho hồ sơ ứng tuyển
...
- Xem xu hướng tìm kiếm phổ biến
...
- Nhận đề xuất việc làm theo định kỳ
- Xem thông báo về công việc phổ biến
- Nhận cảnh báo theo khu vực địa lý
- Xem kết nối quan tâm từ nhà tuyển dụng
...
- Upload logo và hình ảnh công ty
...
- Xuất bản bản nháp tuyển dụng
- Xem thống kê lượt xem và ứng tuyển
- Nhận đề xuất ứng viên phù hợp với vị trí
...
- Xem danh sách ứng viên đã chọn
- So sánh hồ sơ của nhiều ứng viên
- Cập nhật trạng thái ứng tuyển hàng loạt
- Theo dõi timeline đầy đủ của từng ứng viên
- Xem CV chi tiết của ứng viên
- Thêm ghi chú nội bộ cho hồ sơ
...
- Gửi phản hồi và cập nhật cho ứng viên
...
- Gửi cảnh báo dựa trên tìm kiếm đã lưu
...
- Theo dõi thống kê kết nối hiệu quả
- Xóa kết nối không còn quan tâm
...
- Thay đổi vai trò và quyền hạn người dùng
...
- Gán nhãn đặc biệt cho việc làm (Hot, Urgent, Featured)
- Xóa việc làm vi phạm quy định
- Khôi phục việc làm đã xóa
- Xem chi tiết thông tin quản trị của vị trí
...
- Theo dõi và lưu lịch sử tìm kiếm cá nhân
...
- Theo dõi tương tác để cải thiện độ chính xác đề xuất
...
- Hiển thị điểm matching và lý do đề xuất
...
- **Nhà tuyển dụng tìm kiếm**: Nhà tuyển dụng search ứng viên từ hồ sơ ứng tuyển
- **Hệ thống matching**: Đề xuất ứng viên phù hợp nhất cho từng vị trí tuyển dụng
- **Đánh giá và trao đổi**: Nhà tuyển dụng xem hồ sơ, thêm ghi chú, liên hệ trực tiếp
- **Theo dõi tiến trình**: Cập nhật giai đoạn tuyển dụng và thông báo cho ứng viên
...
- Theo dõi thống kê hiệu quả kết nối
- Ứng viên nhận đề xuất việc làm từ mạng lưới kết nối
